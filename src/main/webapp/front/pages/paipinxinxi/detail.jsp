				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div v-if="detail.alllimittimes" class="detail-item">
							...
							<span>拍品编号：</span>
							<span class="desc">
								{{detail.paipinbianhao}}
							</span>
						</div>
																																																												<div class="detail-item">
							<span>开拍时间：</span>
							<span class="desc">
								{{detail.kaipaishijian}}
							</span>
						</div>
																								<div class="detail-item">
							<span>结束时间：</span>
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('paipinxinxi','竞拍')" @click="onAcrossTap('jingpaipaipin')" type="button" class="layui-btn">
								竞拍
							</button>
				...
				<div class="layui-row">
					<div class="layui-tab layui-tab-card">
						...
						<div style="word-break:break-all" class="layui-tab-content">
								...
								<div v-html="detail.baobeijianjie"></div>
							</div>
		...
		<script>
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`paipinxinxi`);
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function() {
				...
				http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function(res) {
					// 详情信息
					vue.detail = res.data
																																			vue.title = vue.detail.paipinmingcheng;
																																																																						// 轮播图片
					vue.swiperList = vue.detail.paipinzhaopian ? vue.detail.paipinzhaopian.split(",") : [];
																																																																																															var swiperItemHtml = '';
