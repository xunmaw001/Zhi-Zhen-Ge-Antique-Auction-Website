					...
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<select name="paipinfenlei" id="paipinfenlei">
							...
							<div class="layui-input-block">
								<input type="text" name="paipinmingcheng" id="paipinmingcheng" placeholder="拍品名称" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                                                                                        <div class="layui-form-item">
							<label class="layui-form-label">开拍时间</label>
							<div class="layui-input-block">
								<input type="text" name="kaipaishijian" id="kaipaishijian" placeholder="开拍时间" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="qipaijia" id="qipaijia" placeholder="起拍价" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">拍品状态</label>
							<div class="layui-input-block">
								<select name="paipinzhuangtai" id="paipinzhuangtai">
									<option value="">请选择</option>
									<option v-for="(item,index) in paipinzhuangtai" v-bind:key="index" :value="item">{{item}}</option>
                                                                                                ...
                                                                                                <div class="layui-form-item">
							<div class="layui-input-block">
								<img id="paipinzhaopianImg" style="width: 100px;height: 100px;border-radius: 50%;border: 2px solid #EEEEEE;" src="../../img/avator.png">
								<input type="hidden" id="paipinzhaopian" name="paipinzhaopian" />
							</div>
						</div>
						<div class="layui-form-item">
							<div class="layui-input-block">
							...
							<div class="layui-input-block">
								<input type="text" name="paimaihao" id="paimaihao" placeholder="拍卖号" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">拍卖人</label>
							<div class="layui-input-block">
								<input type="text" name="paimairen" id="paimairen" placeholder="拍卖人" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                                                                                        <div class="layui-form-item">
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload'], function() {
				...
				http.request(`${table}/session`, 'get', {}, function(data) {
					...
					form.val("myForm", data.data);
																																																																																															// 图片赋值
					jquery("#paipinzhaopianImg").attr("src", data.data.paipinzhaopian);
																																																																																														});
