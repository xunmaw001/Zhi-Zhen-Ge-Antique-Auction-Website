		...
		<div class="login-container">
			...
			<form class="layui-form login-form">
					...
					<div class="layui-input-inline" style="width: 300px;">
						<input type="text" id="paipinbianhao" name="paipinbianhao" placeholder="请输入拍品编号" autocomplete="off" class="layui-input">
					</div>
				</div>
                                                                <div class="layui-form-item layui-form-text">
					...
					<div class="layui-input-inline" style="width: 300px;">
						<input type="text" id="chujia" name="chujia" placeholder="请输入出价" autocomplete="off" class="layui-input">
					</div>
				</div>
